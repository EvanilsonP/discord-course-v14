...
module.exports = {
   ...
   */
    callback: async (client, interaction) => {
        ...
        const reason = intyeraction.options.get('reason')?.value || 'No reason was provided.'
        ...
        if(msDuration < 5000 || msDuration > 2.419e9) {
            await interaction.editReply('Timeout duration cannot be less than 5 seconds and more than 28 days');
            return;
        }
    ...
    options: [
        ...
        {
            name: 'duration',
            description: 'Timeout duration (30min, 1hr, 1 day, etc...)',
